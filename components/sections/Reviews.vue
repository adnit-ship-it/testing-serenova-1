<template>
  <UiSectionWrapper class="flex-col py-20">
    ...
    <div class="w-full flex flex-col gap-5 md:gap-8">
      ...
      }"  :speed="reviewsText?.marquee?.speed" :autoFill="true" class="flex gap-8">
      ...
      }"  :speed="reviewsText?.marquee?.speed" :direction="'right'" :autoFill="true" class="flex gap-8">
        <div class="flex gap-5 md:gap-8">
